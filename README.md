...
[2026 calendar and solutions](https://anicolao.github.io/advent/2026/) · [Experiment archive](https://anicolao.github.io/advent/experiments/)

This repository hosts the finished 2026 Christmas Sudoku calendar's drawing sheets and answers, plus the earlier mosaic and dot-to-dot experiments. Each date has a stable page with explicit reveals and printing for numbered dots, line art, or solved art over the numbers. The 2026 data are frozen from the completed Mathpub edition; experiments do not change those answers.

See [HOSTING.md](HOSTING.md) for local preview, deployment, edition provenance and print sizes.
